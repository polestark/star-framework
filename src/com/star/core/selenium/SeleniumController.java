...
public class SeleniumController {
	...
	protected static final String SERVERIP = CONFIG.get("serverAddr");
	protected static final String RBROWSER = CONFIG.get("runBrowser");
	protected static final String SETUPURL = CONFIG.get("setUpAddr");
	protected static final String SERVPORT = CONFIG.get("serverPort");
	protected static final String CLOSETXT = CONFIG.get("closeTextLog");
