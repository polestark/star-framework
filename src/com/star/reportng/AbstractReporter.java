...
import com.star.reportng.ReportMetadata;
import com.star.reportng.ReportNGException;
import com.star.reportng.ReportNGUtils;
...
public abstract class AbstractReporter implements IReporter {
	...
	private static final ResourceBundle MESSAGES = ResourceBundle.getBundle(
			"com.star.reportng.messages.reportng", META.getLocale());
	 ...
	 ****************************************************************************************/
	private void copyStream(File outputDirectory, InputStream stream, String targetFileName)
			throws IOException {
