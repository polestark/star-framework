...
import com.star.reportng.AbstractReporter;
import com.star.reportng.ReportNGException;
import com.star.reportng.TestClassComparator;
import com.star.reportng.TestMethodComparator;
import com.star.reportng.TestResultComparator;
...
public class HTMLReporter extends AbstractReporter {
	private static final String FRAMES_PROPERTY = "com.star.reportng.frames";

	private static final String TEMPLATES_PATH = "com/star/reportng/templates/html/";
	...
	private void createResults(List<ISuite> suites, File outputDirectory) throws Exception {
		...
		for (ISuite suite : suites) {
			...
			for (ISuiteResult result : suite.getResults().values()) {
				...
				context.put(FAILED_CONFIG_KEY, sortByTestClass(result.getTestContext()
