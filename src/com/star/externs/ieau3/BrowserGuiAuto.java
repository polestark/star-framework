package com.star.externs.ieau3;
...
public class BrowserGuiAuto {
	 ...
	 * 
	 * @param timeout time in sencods to wait for window initialize
	 **/
	...
	/**
	 * click on browser object, found by objectId, using au3 libs</BR> you can use it like this:
	 * ieAU3ClickById("窗口标题", 1, "idvalues");
	 * 
	 * @param ieTitle ie window title
	 * @param ieIndex the window index shared the same title, begins at 1
	 * @param objectId object id value of ie object
	...
	/**
	 * click on browser object, found by object name and index, using au3 libs</BR> you can use it
	 * like this: ieAU3ClickByName("窗口标题", 1, "namevalues", 0);
	 * 
	 * @param ieTitle ie window title
	 * @param ieIndex the window index shared the same title, begins at 1
	 * @param objectName objectName value of ie object
	 * @param ObjectIndex index of the object shared the same objectName, begins at 0
	 * @throws RuntimeException
	 **/
	...
	/**
	 * click on browser object, found by object name and index, using au3 libs</BR> you can use it
	 * like this: ieAU3ClickByName("窗口标题", "namevalues", 0);
	 * 
	 * @param ieTitle ie window title
	 * @param objectName objectName value of ie object
	 * @param ObjectIndex index of the object shared the same objectName, begins at 0
	...
	/**
	 * click on browser object, found by object name and index, using au3 libs</BR> you can use it
	 * like this: ieAU3ClickByName("窗口标题", "namevalues");
	 * 
	 * @param ieTitle ie window title
	 * @param objectName objectName value of ie object
	 * @throws RuntimeException
	...
	/**
	 * click on browser object, found by linktext, default index 0, using au3 libs</BR> you can use
	 * it like this: ieAU3ClickByLinkText("窗口标题", 1, "link texts");
	 * 
	 * @param ieTitle ie window title
	 * @param ieIndex the window index shared the same title, begins at 1
	...
	public void ieAU3ClickByLinkText(String ieTitle, int ieIndex, String linkText) {
		...
		String cmd = "\"" + fileExec + "\" \"" + ieTitle + "\" \"" + ieIndex + "\" \"" + linkText
				+ "\" \"" + maxWait + "\"";
		execute.executeCommands(cmd);
	}
	...
	/**
	 * click on browser object, found by linktext, default index 0, using au3 libs</BR> you can use
	 * it like this: ieAU3ClickByLinkText("窗口标题", "link texts");
	 * 
	 * @param ieTitle ie window title
	 * @param linkText link text of ie links
	 * @throws RuntimeException
	...
	/**
	 * input text to editros, found by objectId, using au3 libs</BR> you can use it like this:
	 * ieAU3SendKeysById("窗口标题", 1, "idvalues", "text content");
	 * 
	 * @param ieTitle ie window title
	 * @param ieIndex the window index shared the same title, begins at 1
	 * @param objectId object id value of ie object
	 * @param textContent text content to be input to editors
	 * @throws RuntimeException
	 **/
	...
	/**
	 * input text to editros, found by object name and its index, using au3 libs</BR> you can use it
	 * like this: ieAU3SendKeysByName("窗口标题", 1, "objectName values", 0, "text content");
	 * 
	 * @param ieTitle ie window title
	 * @param ieIndex the window index shared the same title, begins at 1
	 * @param objectName objectName value of ie object
	 ...
	 * @throws RuntimeException
	 **/
	public void ieAU3SendKeysByName(String ieTitle, int ieIndex, String objectName,
			int ObjectIndex, String textContent) {
	...
	/**
	 * input text to editros, found by object objectName and its index, using au3 libs</BR> you can
	 * use it like this: ieAU3SendKeysByName("窗口标题", "objectName values", 0, "text content");
	 * 
	 * @param ieTitle ie window title
	 * @param objectName objectName value of ie object
	 * @param ObjectIndex index of the object shared the same objectName, begins at 0
	 ...
	 * @throws RuntimeException
	 **/
	public void ieAU3SendKeysByName(String ieTitle, String objectName, int ObjectIndex,
			String textContent) {
	...
	/**
	 * input text to editros, found by object name and its index, using au3 libs</BR> you can use it
	 * like this: ieAU3SendKeysByName("窗口标题", "objectName values", "text content");
	 * 
	 * @param ieTitle ie window title
	 * @param objectName objectName value of ie object
	 * @param textContent text content to be input to editors
