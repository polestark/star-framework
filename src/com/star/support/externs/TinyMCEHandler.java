...
public class TinyMCEHandler {
	...
	private String getPopupID() {
		return driver.findElement(By.xpath("//div[starts-with(@id, 'mce_')][@class='clearlooks2']"))
				.getAttribute("id");
	}
	...
	public void replaceHTMLSource(String value) throws Exception {
		...
		String sourceBlockID = driver.findElement(
				By.xpath("//div[@id='mceModalBlocker']/preceding-sibling::div")).getAttribute("id");
