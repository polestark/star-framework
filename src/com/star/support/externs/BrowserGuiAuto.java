...
public class BrowserGuiAuto {
	...
	/**
	 * click on browser object, found by objectId, using au3 libs</BR>
	 * you can use it like this: ieAU3ClickById("窗口标题", 1, "idvalues");
	 * 
	...
	/**
	 * click on browser object, found by object name and index, using au3 libs</BR>
	 * you can use it like this: ieAU3ClickByName("窗口标题", 1, "namevalues", 0);
	 * 
	 * @param	ieTitle ie window title
	 * @param	ieIndex the window index shared the same title, begins at 1
	 ...
	 * you can use it like this: ieAU3ClickByLinkText("窗口标题", 1, "link texts");
	 * 
	 * @param	ieTitle ie window title
	 * @param	ieIndex the window index shared the same title, begins at 1
	...
	/**
	 * input text to editros, found by objectId, using au3 libs</BR>
	...
	/**
	 * input text to editros, found by object name and its index, using au3 libs</BR>
	 * you can use it like this: ieAU3SendKeysByName("窗口标题", 1, "objectName values", 0, "text content");
	 * 
	 * @param	ieTitle ie window title
	 * @param	ieIndex the window index shared the same title, begins at 1
	 * @param	objectName objectName value of ie object
	...
	/**
	 * input text to editros, found by object objectName and its index, using au3 libs</BR>
	 * you can use it like this: ieAU3SendKeysByName("窗口标题", "objectName values", 0, "text content");
	 * 
	 * @param	ieTitle ie window title
	 * @param	objectName objectName value of ie object
	 * @param	ObjectIndex index of the object shared the same objectName, begins at 0
	...
	/**
	 * input text to editros, found by object name and its index, using au3 libs</BR>
	 * you can use it like this: ieAU3SendKeysByName("窗口标题", "objectName values", "text content");
	 * 
	 * @param	ieTitle ie window title
	 * @param	objectName objectName value of ie object
	 * @param	textContent text content to be input to editors
